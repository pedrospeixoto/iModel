...
#Test Case 1 - solid body rot
awk '{ if ( NR == 3 ) { print "1 0";} else {print $0;} }'  par/swm.par > par/swm2.par
awk '{ if ( NR == 3 ) { print "1 0";} else {print $0;} }'  par/swm2.par > par/swm.par

#HTC TRSK Method
awk '{ if ( NR == 9 ) { print "HTC";} else {print $0;} }'  par/swm.par > par/swm2.par
awk '{ if ( NR == 11 ) { print "trsk 0.75";} else {print $0;} }'  par/swm2.par > par/swm.par

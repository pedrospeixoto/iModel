...
%General parameters
nmtds=4;
methods=cellstr(char('swm_tc6_dt50_HTC_vrectrsk_crectrsk_sinttrsk_grdtrsk', ...
    'swm_tc6_dt50_HTC_vrectrsk_crectrsk_sinttrsk_grdtrsk', ...
    'swm_tc6_dt50_HC_vrecperhx_crecpered_sintbary_grdtrsk', ...
    'swm_tc6_dt50_HC_vrecperhx_crecpered_sintbary_grdtrsk'));
...
ref1=0.0025;
ref2=0.09;
plotgraph_tc6(ds, time, variable, methods, nmtds, grids, methodnames, ref1, ref2)
ylabel('Max Error','fontsize',12)
%xlabel('glevel','fontsize',12)
title('TC6 Max Errors Day 5','fontsize',12 )
box off;
axis([5 8 0.00002 0.003])
set(gca,'XTick',[5:1:8])
...
%xlabel('glevel','fontsize',12)
title('TC6 RMS Errors Day 5','fontsize',12 )
box off;

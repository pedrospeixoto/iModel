function plotgraph_tc6(ds, time, variable, methods, nmtds, grids, names1, ref1, ref2)
format short e
...
hold off;
i=1;
yds=ds(strcmp(ds.swmname,methods(i)) & ...
...
semilogy(xref(6:7),ref(5:6,1),'-', 'Color', [152/256 152/256 152/256],'LineWidth',1.0, 'DisplayName', 'O1' )
semilogy(xref(6:7),ref(5:6,2),'-', 'Color', [152/256 152/256 152/256],'LineWidth',1.0, 'DisplayName', 'O2' )

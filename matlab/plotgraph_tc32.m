function plotgraph_tc32(ds, time, variable, methods, nmtds, grids, names1, ref1, ref2)
format short e
...
hold off;
i=1;
yds=ds(strcmp(ds.swmname1,methods(i)) & ...
   strcmp(ds.grid,grids(i)) , {'Glevel',variable});
x=yds.Glevel(2:end);
y=yds(2:end,2); 
y
...
semilogy(xref(3:6),ref(3:6,1),'-', 'Color', [152/256 152/256 152/256],'LineWidth',1.0, 'DisplayName', 'O1' )
semilogy(xref(3:6),ref(3:6,2),'-', 'Color', [152/256 152/256 152/256],'LineWidth',1.0, 'DisplayName', 'O2' )

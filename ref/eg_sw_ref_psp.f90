...
phiref = 1.0d+2*gravity ! for Hollingsworth test
...
! List of reference solution file prefixes
   yrefpre( igref) = 'TC51_'//trim(ygc(igref))
end do
...
reftime(6) = 5.0d0*86400.0         ! 5 days
reftime(7) = 6.0d0*86400.0         ! 6 days
reftime(8) = 10.0D0*86400.0        ! 10 days
reftime(9) = 14.0D0*86400.0        ! 14 days
reftime(10) = 15.0d0*86400.0        ! 15 days

if(istep==1)then
	OPEN(58,FILE='TC51_reftimes.dat', status='replace')
	write(58, *) nreftime
	DO ilist = 1, nreftime

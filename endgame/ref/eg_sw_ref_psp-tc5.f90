...
nreftime = 9              ! Number of times at which reference solution is required
...
! List of reference solution file prefixes
   yrefpre( igref) = 'TC05_'//trim(ygc(igref))
end do
...
reftime(7) = 10.0D0*86400.0        ! 10 days
reftime(8) = 14.0D0*86400.0        ! 14 days
reftime(9) = 15.0d0*86400.0        ! 15 days

if(istep==1)then
	OPEN(58,FILE='TC05_reftimes.dat', status='replace')
	write(58, *) nreftime
	DO ilist = 1, nreftime

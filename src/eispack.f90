...
400 continue
  ...
  subroutine rg ( n, a, wr, wi, matz, z, ierr )
    ...
    print*
    print*, "Calculating eigenvalues...please wait"
    print*
    print*,"Balancing..."
    ...
    if ( matz == 0 ) then
       print*, "Computes all eigenvalues of a real upper Hessenberg matrix..."
       ...
       print*, "Accumulates similarity transformations..."
       call eltran ( n, is1, is2, a, iv1, z )
       print*, "Computes eigenvalues and eigenvectors of a real upper Hessenberg matrix..."
       call hqr2 ( n, is1, is2, a, wr, wi, z, ierr )

       if ( ierr /= 0 ) then
          return
       end if
        print*, "Undo balancing..."

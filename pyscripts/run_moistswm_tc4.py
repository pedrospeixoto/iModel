# -----------------------------------------------------------------------
# Python script to run test case 4 (barotropic instability)
# of the moist shallow water model
#
...
gridnames=(grid_ref, grid_ref, grid_ref, )
gridnames=(grid_ref, grid_ref, )
gridnames=(grid_ref, )
...
# time step
DTs_unif = ('1920','960','480','240','120','60','30')
DTs_ref  = ('960','480','240','120','60','30','15')
...
hyp_10to16, hyp_10to16_str = 10*hyp_10to15, hyp_type+'_hyperdiffusion_10to16.000_'

# coeffs for refined grid
hyp_coefs_str_ref = (hyp_10to12_str, hyp_10to12_str, hyp_10to12_str, hyp_10to12_str, hyp_10to16_str, hyp_10to15_str, hyp_10to15_str,)
hyp_coefs_ref = (hyp_10to12, hyp_10to12, hyp_10to12, hyp_10to12, hyp_10to16, hyp_10to15, hyp_10to15,)


# coeffs for uniform grid
hyp_coefs_str = ('','','','','', hyp_10to15_str, hyp_10to15_str)
hyp_coefs     = (0 ,0 , 0, 0, 0, hyp_10to15    , hyp_10to15)

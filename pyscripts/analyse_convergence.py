...
if "loc_trunc" in input_filename:
	loc_trunc=True
else:
	loc_trunc=False
...
if loc_trunc: #Local truncation results
	...
	imethod = head.index("SWMparameters")
	igridres = head.index("n")
	imaxerror = head.index("errormax_h")
	irmserror = head.index("error2_h")
